        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <p class="text-center text-green-600 text-2xl font-bold mb-5">All Posts</p>
                        ...
                        @foreach($posts as $post)
                            ...
                            <a href="/post/{{$post->id}}" class="flex p-3 pb-7 mb-3 bg-gray-200 rounded-lg hover:bg-green-100 hover:shadow-xl focus:bg-green-100 focus:shadow-xl focus:outline-none">
                                ...
                                <div class="flex-1 mx-6">
                                    ...
                                    <span class="mt-2 text-base text-gray-500">Written by: <span class="text-green-600">{{$post->user->name}}</span></span>
