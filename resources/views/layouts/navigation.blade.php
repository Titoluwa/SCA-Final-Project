    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div class="mr-3 hover:text-green-700 flex items-center text-sm font-medium text-green-500 hover:text-p-700 hover:border-p-300 focus:outline-none focus:text-green-700 focus:border-green-300 transition duration-150 ease-in-out">
                    <a href="/post/create">New Post</a>
                </div>
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-green-500 hover:text-p-700 hover:border-p-300 focus:outline-none focus:text-green-700 focus:border-green-300 transition duration-150 ease-in-out">

                            <div class="hover:text-green-700">{{ Auth::user()->name }}</div>

                            <div class="ml-1 hover:text-green-700">
